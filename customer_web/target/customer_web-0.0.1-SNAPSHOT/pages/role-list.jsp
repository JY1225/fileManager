    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/pages/role-list.html">角色管理</a></li>
                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建" onclick="location.href='role-add.html'">
                            ...
                            <c:forEach items="${pageInfo.list}" var="role">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/role/findNotPermissions?id=${role.id}" class="btn bg-olive btn-xs">添加角色</a>
                                    </td>
                                </tr>
                            </c:forEach>
